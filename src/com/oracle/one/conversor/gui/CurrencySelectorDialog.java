...
public class CurrencySelectorDialog {
  ...
  public CurrencySelectorDialog(Window owner) {
    ...
    this.table =
      new JTable(tableData, tableColumns) {
        @Override
    ...
    this.searchField.setPreferredSize(
        new Dimension(150, this.searchField.getPreferredSize().height)
      );

    this.searchField.getDocument()
      .addDocumentListener(
  ...
  private void loadTableData() {
    ...
    this.currenciesIso =
      currenciesIsoSet.toArray(new String[currenciesIsoSet.size()]);
  ...
  public Currency showDialog(String initialIso) {
    ...
    while (true) {
      int dialogResult = JOptionPane.showConfirmDialog(
        this.owner,
        new JComponent[] { this.searchPanel, this.pane },
      ...
      Currency selectedCurrency = Currencies.get(
