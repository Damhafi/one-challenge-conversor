...
import com.oracle.one.conversor.temperature.TemperatureConversor;
...
public class ConversorDeTemperaturaWindow extends JDialog {
  ...
  public ConversorDeTemperaturaWindow(JFrame owner) {
    ...
    valueField.setPreferredSize(
      new Dimension(100, valueField.getPreferredSize().height)
    );
    ...
    this.convertBtn.addActionListener(
        new ActionListener() {
          ...
          public void actionPerformed(ActionEvent e) {
            ...
            double convertedValue = TemperatureConversor.convert(
              value,
              from,
              to
            );
            ...
            String msg =
              "" +
              value +
              fromMetric.substring(0, 1) +
              " = " +
              convertedValue +
              toMetric.substring(0, 1);
            String title =
              "Conversão de " + fromMetric + " para " + toMetric + ":";
