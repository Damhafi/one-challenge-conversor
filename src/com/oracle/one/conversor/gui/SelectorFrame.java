...
public class SelectorFrame extends JFrame {
  ...
  public SelectorFrame() {
    ...
    try {
      currencyBtn.setIcon(
        new ImageIcon(
          new URL("https://cdn-icons-png.flaticon.com/64/8887/8887786.png")
        )
      );
    } catch (Exception e) {
    ...
    try {
      temperatureBtn.setIcon(
        new ImageIcon(
          new URL("https://cdn-icons-png.flaticon.com/64/2387/2387835.png")
        )
      );
    } catch (Exception e) {
      // TODO Auto-generated catch block
    ...
    temperatureBtn.addActionListener(
      new ActionListener() {
        @Override
        public void actionPerformed(ActionEvent e) {
          ConversorDeTemperaturaWindow dialog = new ConversorDeTemperaturaWindow(
            _this
          );
          dialog.setVisible(true);
        }
