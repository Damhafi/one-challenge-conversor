package com.oracle.one.conversor.api;
...
public class APIHandler {
  ...
  private static final PropsLoader props = new PropsLoader();

  private static final boolean API_ENABLED =
    props.getProperty("api.enabled") != null &&
    props.getProperty("api.enabled").equals("true");

  // TODO Remove public API_KEY
  private static final String API_KEY = props.getProperty("api.key");
  private static final String API_VERSION = "v3";
  private static final String API_PROTOCOL_HOST = "https://api.currencyapi.com";

  public static final String BASE_CURRENCY = props.getProperty(
    "api.base_currency",
    "USD"
  );
