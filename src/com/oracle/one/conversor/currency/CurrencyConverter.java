...
public class CurrencyConverter {
  ...
  public static double convert(double value) {
    ...
    if (sourceCurrency == null) throw new NullPointerException(
      "Please provide a source currency"
    );
    if (targetCurrency == null) throw new NullPointerException(
      "Please provide a target currency"
    );
